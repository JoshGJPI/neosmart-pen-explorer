...
class PenHelper {
  ...
  async scanPen(options) {
    try {
      ...
      // Use provided options if available, otherwise use default
      ...
      // Log the filters being used to help with debugging
      this.logDebug("Bluetooth scan options:", scanOptions);
